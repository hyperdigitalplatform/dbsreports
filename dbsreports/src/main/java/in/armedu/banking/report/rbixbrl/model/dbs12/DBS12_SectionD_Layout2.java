...
@Setter
@Getter
public class DBS12_SectionD_Layout2 {
    
    
            private String uniqueTransactionCodeAxis = new String();
        
            private String nameOfAssistedDirectorManagerOrEnterpriseOfTheirInterestAxis = new String();
        
            private String nameOfInterestedDirectorManagerAxis = new String();
